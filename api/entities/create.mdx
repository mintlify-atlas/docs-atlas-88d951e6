...
```bash curl
curl -X POST https://api.useautumn.com/v1/customers/team_123/entities \
...
const entity = await autumn.entities.create('team_123', {
  id: 'user_456',
  name: 'Alice Johnson',
...
response = requests.post(
    'https://api.useautumn.com/v1/customers/team_123/entities',
    headers={
