...
```bash curl
curl -X GET "https://api.useautumn.com/v1/entities/user_456" \
  -H "Authorization: Bearer sk_test_..."
```

```bash curl (with expansion)
curl -X GET "https://api.useautumn.com/v1/entities/user_456?expand=invoices&expand=subscriptions.plan" \
  -H "Authorization: Bearer sk_test_..."
```
