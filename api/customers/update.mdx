...
Update customer details including their name, email, metadata, and preferences. You can also change the customer's unique identifier if needed.
...
curl -X PATCH https://api.autumn.ai/v1/customers/customer_12345 \
